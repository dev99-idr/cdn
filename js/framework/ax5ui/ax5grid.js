    	...
    	var ax5grid = function ax5grid() {
            ...
            this.config = {
                ...
                tree: {
                    ...
                    iconWidth: 18,
                    icons: {
                        openedArrow: '<i class="fa fa-caret-down fa-w-10" aria-hidden="true" style="padding-right: 5px"></i>',
                        collapsedArrow: '<i class="fa fa-caret-right" aria-hidden="true" style="padding-right: 5px ;color: darkgray"></i>',
                        groupIcon: '<i class="fa fa-folder-open" aria-hidden="true" style="padding-right: 5px"></i>',
                        collapsedGroupIcon: '<i class="fa fa-folder" aria-hidden="true" style="padding-right: 5px ;color: darkgray"></i>',
                        itemIcon: '<i class="fas fa-location-arrow" aria-hidden="true" style="padding-right: 5px ;color: darkolivegreen"></i>'
                    },
                    columnKeys: {
                        parentKey: "pid",
                        selfKey: "id",
            ...
            var onStateChanged = function (_opts, _that) {
            ...
            var initGrid = function initGrid() {
                ...
                this.$ = {
                    ...
                    "scroller": {
                        ...
                        "vertical-arrowDown": this.$target.find('[data-ax5grid-scroller="vertical-arrowDown"]'),
                        "vertical-arrowUp": this.$target.find('[data-ax5grid-scroller="vertical-arrowUp"]'),
            ...
            var resetFixedWidth = function () {
                ...
                for (i = 0, l = colGroup.length; i < l; i++) {
                    totalWidth += colGroup[i]._width;
                }

                widthRatio = CT_WIDTH / totalWidth;
                totalWidth = CT_WIDTH;


                for (i = 0, l = colGroup.length - 1; i < l; i++) {
                    totalWidth -= colGroup[i]._width = (colGroup[i]._width * widthRatio);
                }
                colGroup[i]._width = totalWidth;
            };
            ...
            var alignGrid = function alignGrid(_isFirst) {
                var list = this.proxyList ? this.proxyList : GRID.proxyData.getData.call(this);
                ...
                (function () {
                    ...
                    verticalScrollerWidth = CT_HEIGHT - headerHeight - pageHeight - footSumHeight < GRID.proxyData.size.call(this) * this.xvar.bodyTrHeight ? this.config.scroller.size : 0;
                    ...
                    if (horizontalScrollerHeight > 0) {
                    	verticalScrollerWidth = CT_HEIGHT - headerHeight - pageHeight - footSumHeight - horizontalScrollerHeight < GRID.proxyData.size.call(this) * this.xvar.bodyTrHeight ? this.config.scroller.size : 0;
                    }
                }).call(this);
                ...
                if (U.isFunction(this.config.remoteSort)) {
                    ...
                    for (var k in _sortInfo) {
                        that.sortInfo.push({
                            ...
                            seq: _sortInfo[k].seq,
                            formatter: _sortInfo[k].formatter
                        });
                    }
                	...
                	if (this.config.body.grouping) {
                        ...
                        GRID.proxyData.clearGroupingData.call(this);
                        GRID.proxyData.sort.call(this, _sortInfo);
                        GRID.data.initData.call(this, GRID.proxyData.getData.call(this));
                    } else {
            ...
            this.init = function (_config) {
                ...
                this.onDblClick = cfg.body.onDblClick;
                this.onLoad = cfg.onLoad;
                this.onDataChanged = cfg.body.onDataChanged;

                this.onBeforeEdit = cfg.body.onBeforeEdit;
                this.canDataChange = cfg.body.canDataChange;
                this.canRowChange = cfg.body.canRowChange;
                this.onRowChanged = cfg.body.onRowChanged;
                this.canCellChange = cfg.body.canCellChange;
                this.onCellChanged = cfg.body.onCellChanged;
                this.onSortingChanged = cfg.body.onSortingChanged;
                this.onExtendClick = cfg.body.onExtendClick;
             ...
             * @returns {ax5grid}
             */
            this.setEvents = function (_config) {
                jQuery.extend(true, this.config, _config);
                cfg = jQuery.extend(true, {}, cfg, _config);
            ...
            this.copySelect = function () {
                ...
                for (var c in this.selectedColumn) {
                    ...
                    if (_column) {
                        ...
                        if (originalColumn) {
                            if (GRID.proxyData.isGrouping.call(this, _column.dindex)) {
                                copyTextArray[_di].push(GRID.proxyData.get.call(this, _column.dindex, _column.colIndex));	//this.list[_column.dindex][_column.colIndex]);
                            } else {
                                copyTextArray[_di].push(GRID.proxyData.get.call(this, _column.dindex, originalColumn.key));	//this.list[_column.dindex][originalColumn.key]);
                            }
                        } else {
             ...
             * ```
             */
            this.removeRow = function (_dindex, _options) {
                GRID.data.remove.call(this, _dindex, _options);
                alignGrid.call(this);
                GRID.body.repaint.call(this, "reset");
                // 삭제시엔 포커스 ?
                // GRID.body.moveFocus.call(this, this.config.body.grouping ? "START" : "END");
            ...
            this.getColumnSortInfo = function () {
                ...
                for (var k in this.sortInfo) {
                    that.sortInfo.push({
                        ...
                        formatter: this.sortInfo[k].formatter
                    });
                }
                that.sortInfo.sort(function (a, b) {
                    return a.seq > b.seq;
             ...
             * ```
             */
            this.selectAll = function (_options, _elm) {
                if (this.canDataChange) {
                    if (!this.canDataChange.call(this, {
                            self: this,
                            type: "SELECT_ALL",
                            list: GRID.proxyData.getData.call(this), //this.list,
                        })) {
                        var selected = _elm.attr("data-ax5grid-selected");
                        selected = U.isNothing(selected) ? true : selected === "true" ? false : true;
                        _elm.attr("data-ax5grid-selected", selected);
                        return;
                    }
                }
                    ...
                    if (typeof this.selectedDataIndexs[0] === "undefined") {
                        ...
                        (function () {
                            ...
                            var processor = {
                                ...
                                "DOWN": function DOWN() {
                                    if (selectedIndex < GRID.proxyData.size.call(this) - 1) {	//this.list.length - 1) {
                                        this.select(selectedIndex + 1, {selectedClear: true});
                                        GRID.body.moveFocus.call(this, selectedIndex + 1);
                                    }
                                },
                                ...
                                "END": function END() {
                                    ...
                                    this.select(GRID.proxyData.size.call(this) - 1, {selectedClear: true});

                                    GRID.body.moveFocus.call(this, GRID.proxyData.size.call(this) - 1);	// this.list.length - 1);
                                }
                            };
            ...
            this.moveFocus = function (_pos, _key) {
                GRID.body.moveFocus.call(this, _pos, _key);
            };
            ...
            this.destroy = function () {
                ...
                this.$target.empty();
                GRID.proxyData.clear.call(this);
...
(function () {
    ...
    var columnSelect = {
        ...
        init: function init(column) {
            var self = this;
            var cols = [];
            this.bodyRowTable.rows.forEach(function (row) {
                cols = cols.concat(row.cols.map(function (col) {
                    return col;
                }))
            });

        	//키값인 경우 disabled 세팅
        	for (var i = this.columns.length - 1; i >= 0; i--) {		//박광섭 수정 Row 변경시 키값인 경우  disabled 해제
        		if (this.columns[i].keyYn == true) {
        			if(this.data._rows[column.dindex]._rowStatus == "INSERT") {
        				eval('$("#' + this.columns[i].key + '").attr("disabled", false);') ;
        			} else {
        				eval('$("#' + this.columns[i].key + '").attr("disabled", true);') ;
        			}
        		}
        	}

            var oldFocusedColumn = $.map(self.focusedColumn, function (a) {
                return a
            });
            oldFocusedColumn = oldFocusedColumn.length > 0 ? oldFocusedColumn[0] : {
                    dindex: -1,
                    colIndex: -1,
                    rowIndex: -1
                };
            ...
            if (this.canRowChange && oldFocusedColumn.dindex != column.dindex) {
                if (!this.canRowChange.call(this, {
                        self: this,
                        list: GRID.proxyData.getData.call(this),
                        dindex: column.dindex,
                        oldDindex: oldFocusedColumn.dindex,
                        item: GRID.proxyData.get.call(this, column.dindex)
                    }))
                    return false;
            }

            if (this.canCellChange &&
                (oldFocusedColumn.dindex != column.dindex || oldFocusedColumn.rowIndex != column.rowIndex || oldFocusedColumn.colIndex != column.colIndex)) {
                if (!this.canCellChange.call(this, {
                        self: this,
                        list: GRID.proxyData.getData.call(this),
                        dindex: column.dindex,
                        rowindex: column.rowIndex,
                        colIndex: column.colIndex,
                        key: (cols.filter(function (col) {
                            if (col.key && col.rowIndex == column.rowIndex && col.colIndex == column.colIndex) return true;
                        })[0] || [{key: undefined}][0]).key,
                        oldDindex: oldFocusedColumn.dindex,
                        oldRowindex: oldFocusedColumn.rowIndex,
                        oldColIndex: oldFocusedColumn.colIndex,
                        oldKey: (cols.filter(function (col) {
                            if (col.key && col.rowIndex == oldFocusedColumn.rowIndex && col.colIndex == oldFocusedColumn.colIndex) return true;
                        })[0] || [{key: undefined}][0]).key,
                        item: GRID.proxyData.get.call(this, column.dindex)
                    }))
                    return false;
            ...
            GRID.proxyData.setPosition.call(this, column.dindex);

            if (this.onRowChanged && oldFocusedColumn.dindex != column.dindex) {
            ...
            if (this.onCellChanged &&
                (oldFocusedColumn.dindex != column.dindex || oldFocusedColumn.rowIndex != column.rowIndex || oldFocusedColumn.colIndex != column.colIndex)) {
                this.onCellChanged.call(this, {
                    self: this,
                    list: GRID.proxyData.getData.call(this),
                    dindex: column.dindex,
                    rowindex: column.rowIndex,
            ...
            if (this.isInlineEditing) {
                GRID.body.inlineEdit.deActive.call(this, "RETURN", oldFocusedColumn.dindex + "_" + oldFocusedColumn.colIndex + "_" + oldFocusedColumn.rowIndex);
            }
    ...
    var columnSelector = {
        "on": function on(cell) {
            ...
            selected = columnSelect.init.call(self, cell);
        ...
        var self = this,
            ...
            processor = {
                "selected": function selected(_dindex) {
                    ...
                    while (i--) {
                        this.$.panel[this.$.livePanelKeys[i]].find('[data-ax5grid-tr-data-index="' + _dindex + '"]').attr("data-ax5grid-selected", GRID.proxyData.isSelected.call(this, _dindex));	//this.list[_dindex][cfg.columnKeys.selected]);
                    }
                },
                "selectedClear": function selectedClear() {
                    var si = this.selectedDataIndexs.length;
                	var di = GRID.proxyData.size.call(this);
                	var pi = void 0;
                	...
                	if (!this.proxyList) {
                    	while (si--) {
                        	...
                        	while (i--) {
                            	...
                            	GRID.proxyData.setSelected.call(this, dindex, false);	//this.list[dindex][cfg.columnKeys.selected] = false;
                        	}
                    	}
                    } else {
                    	while (di--) {
                        	GRID.proxyData.setSelected.call(this, di, false);
                    	}
                    	di = this.proxyList.length;
                    	while (di--) {
                        	if (GRID.proxyData.setSelected.call(this, di)) {
            ...
            var panelName = void 0,
                ...
                targetClick = {
                    "default": function _default(_column) {
                    	/* 2020.06.12 by 박광섭 그리드 컬럼이 아닌 그리드의 빈곳  선택시 작동 안하도록 */
                    	if(isNaN(_column.col)) return ;
                        var column = self.bodyRowMap[_column.rowIndex + "_" + _column.colIndex],
                            that = {
                                self: self,
                                page: self.page,
                                list: GRID.proxyData.getData.call(self), //self.list,
                                item: GRID.proxyData.get.call(self, _column.dindex), //self.list[_column.dindex],
                                dindex: _column.dindex,
                                rowIndex: _column.rowIndex,
                                colIndex: _column.colIndex,
                                column: column,
                                value: GRID.proxyData.get.call(self, _column.dindex, column.key)	//self.list[_column.dindex][column.key]
                            };
                        ...
                        if (column.editor && column.editor.type == "checkbox") {
                            ...
                            var flag = GRID.data.setValue.call(self, _column.dindex, column.key, newValue);
                         ...
                         //박광섭 추가 click으로 에디트 가능하도록 추가
                        } else if (column.editor && (column.editor.type == "select" || column.editor.type == "text" || column.editor.type == "number" || column.editor.type == "money" || column.editor.type == "date")) {
//                        } else if (column.editor && (column.editor.type == "select" || column.editor.type == "text" || column.editor.type == "number" || column.editor.type == "money")) {
                            if (self.isInlineEditing) {
                            ...
                            var column = self.bodyRowMap[_column.rowIndex + "_" + _column.colIndex],
                                value = "";
                            if (column) {
                                if (!GRID.proxyData.isGrouping.call(self, dindex)) {//self.list[dindex].__isGrouping) {
    	                    ...
    	                    if (U.isObject(editor)) {
    	                    	...
    	                    	if (self.config.body.onDblClick) {
    	                            ...
    	                            self.config.body.onDblClick.call(self, that);
    	                        }
    	                    }
                            if (self.config.body.onClick) {
                                self.config.body.onClick.call(self, that);
                            }
                        } else {
                            if (self.config.body.onClick) {
                                self.config.body.onClick.call(self, that);
                    ...
                    "rowSelector": function rowSelector(_column) {
                    	var item = self.list[_column.dindex];
                        if (GRID.proxyData.isDisableSelection.call(self, _column.dindex)) {	//self.list[_column.dindex][self.config.columnKeys.disableSelection]) {
                            return false;
                        }
        ...
        this.$["container"]["body"].on("mousedown", '[data-ax5grid-column-attr="default"]', function (e) {
            ...
            if (this.getAttribute("data-ax5grid-column-rowIndex")) {
                ...
                var select = columnSelector.on.call(self, cell);

                if (select && self.onExtendClick && $target.attr("data-extend-event") == "true") {
                    var cols = [];
                    self.bodyRowTable.rows.forEach(function (row) {
                        cols = cols.concat(row.cols.map(function (col) {
                            return col;
                        }))
                    });
                    self.onExtendClick.call(self, {
                        self: self,
                        list: GRID.proxyData.getData.call(self),
                        dindex: cell.dindex,
                        rowindex: cell.rowIndex,
                        colIndex: cell.colIndex,
                        key: (cols.filter(function (col) {
                            if (col.key && col.rowIndex == cell.rowIndex && col.colIndex == cell.colIndex) return true;
                        })[0] || [{key: undefined}][0]).key,
                        item: GRID.proxyData.get.call(self, cell.dindex),
                        target: e.target
                    })
                }
            }
   ...
   var getFieldValue = function getFieldValue(_list, _item, _index, _col, _value, _returnPlainText) {
        ...
        if (_key === "__d-index__") {
            ...
            var valueProcessor = {
                "formatter": function formatter() {
                	...
                	if (U.isFunction(_col.formatter)) {
                    	return _col.formatter.call(that, _col);
                	} else if (_col.formatter instanceof Object) {
                    	return GRID.formatter[_col.formatter.type].call(that, _col);
                	} else {
                    	return GRID.formatter[_col.formatter].call(that, _col);
                	}
                },
            ...
            if (this.config.tree.use && _col.treeControl) {
            	if(typeof(_item.__children__) == "object"){
    ...
    var getGroupingValue = function getGroupingValue(_item, _index, _col) {
        ...
        if (typeof _key === "undefined") {
            that = {
                key: _key,
                list: GRID.proxyData.getGroupingList.call(this, _index), 	//_item.__groupingList,
                groupBy: GRID.proxyData.getGroupingBy.call(this, _index)
            };
            ...
            if (_col.collector) {
                that = {
                    key: _key,
                    list: GRID.proxyData.getGroupingList.call(this, _index)
                };
    ...
    var repaint = function repaint(_reset) {
        // debugger;
        var cfg = this.config,
//        list = this.proxyList ? this.proxyList : GRID.proxyData.getData.call(this);	//this.list;
        ...
        // 왜그런지 모르겠으나 -7이 나오면서 화면이 깨짐(by 박광섭)
        if (paintStartRowIndex < 0)  return this;
        ...
        this.xvar.scrollContentHeight = this.xvar.bodyTrHeight * (GRID.proxyData.size.call(this) - this.xvar.frozenRowIndex);
        /// 사용된 패널들의 키 모음
        this.$.livePanelKeys = [];
        ...
        var repaintBody = function repaintBody(_elTargetKey, _colGroup, _bodyRow, _groupRow, _list, _scrollConfig) {
           ...
           for (di = _scrollConfig.paintStartRowIndex, dl = function () {
                ...
                var _self = this;
                if (_groupRow && GRID.proxyData.isGrouping.call(_self, di)) {	//_list[di]) {
                    rowTable = _groupRow;
                    isGroupingRow = true;
                } else {
                    rowTable = _bodyRow;
                ...
                for (tri = 0, trl = rowTable.rows.length; tri < trl; tri++) {
                    ...
                    SS.push('<tr class="tr-' + 0 + '"', isGroupingRow ? ' data-ax5grid-grouping-tr="true"' : '', ' data-ax5grid-tr-data-index="' + di + '"', ' data-ax5grid-selected="' + (GRID.proxyData.isSelected.call(this, di) || "false") + '"', ' data-ax5grid-disable-selection="' + (GRID.proxyData.isDisableSelection.call(this, di) || "false") + '"', '>');
                    for (ci = 0, cl = rowTable.rows[tri].cols.length; ci < cl; ci++) {
                            ...
                            return attrs;
                                ...
                                if (_col.styleClass) {
                                    if (U.isFunction(_col.styleClass)) {
                                        tdCSS_class += _col.styleClass.call(this, {
                                                column: _col,
                                                key: _col.key,
                                                item: _list[di],
                                                index: di
                                ...
                                return tdCSS_class;
                            }.call(this, col) + '" ', 'style="height: ' + cellHeight + 'px;min-height: 1px; white-space:nowrap;">');
                        ...
                        if(col.formatter == "select") {
	                        SS.push(function (_cellHeight) {
	                            ...
	                            return '<span data-ax5grid-cellHolder="' + (col.multiLine ? 'multiLine' : '') + '" ' + (colAlign ? 'data-ax5grid-text-align="' + colAlign + '"' : '') + '" style="width: 85%;display: inline-block;" >';
	                        }(cellHeight), isGroupingRow ? getGroupingValue.call(this, _list[di], di, col) : getFieldValue.call(this, _list, _list[di], di, col), '</span>');
//	                        SS.push('<img src="' + gv_ContextPath + '/images/common/btn_down.png" style=" position: absolute; top:0; right:0;" data-select-event="true">');
//	                        SS.push('<i style="margin-top: 3px;" class="fas fa-caret-down" data-select-event="true"></i>');
	                        SS.push('<a style="width:15%; font-size:15px"><i style="height:29px;"class="fas fa-caret-down fa-w-10" ></i></a>');

	                        SS.push('</td>');
                    	} else if (col.formatter == "textButton") {
	                        SS.push(function (_cellHeight) {
	                            var lineHeight = cfg.body.columnHeight - cfg.body.columnPadding * 2 - cfg.body.columnBorderWidth;
	                            if (!col.multiLine) {
	                                _cellHeight = cfg.body.columnHeight - cfg.body.columnBorderWidth;
	                        ...
	                        }(cellHeight), isGroupingRow ? getGroupingValue.call(this, _list[di], di, col) : "");
                            var imageUri = gv_ContextPath + "/images/common/btn_search.png";
                            SS.push("<div style='width:100%; height:100%; position: relative; display:block; overflow:hidden'>");
                            SS.push( getFieldValue.call(this, _list, _list[di], di, col));
                            SS.push("<img src='" + imageUri + "' style=' position: absolute; top:0; right:0;' data-extend-event='true'/>");
                            SS.push("</div>");
                            SS.push("</span>");
	                        SS.push('</td>');
                    	} else if (col.formatter == "iconButton") {
	                        SS.push(function (_cellHeight) {
	                            var lineHeight = cfg.body.columnHeight - cfg.body.columnPadding * 2 - cfg.body.columnBorderWidth;
	                            if (!col.multiLine) {
	                                _cellHeight = cfg.body.columnHeight - cfg.body.columnBorderWidth;
	                            }
	                            return '<span data-ax5grid-cellHolder="' + (col.multiLine ? 'multiLine' : '') + '" ' + (colAlign ? 'data-ax5grid-text-align="center"' : '') + '" style="height:' + _cellHeight + 'px;line-height: ' + lineHeight + 'px;">';
	                        }(cellHeight), isGroupingRow ? getGroupingValue.call(this, _list[di], di, col) : "");
                            SS.push("<div style='width:100%; height:100%; position: relative; display:block; overflow:hidden'>");
//                            SS.push( getFieldValue.call(this, _list, _list[di], di, col));
//                            SS.push("'" + iconHtml + "'");
							...
							/*
							* TO-DO : key값을 가져와서  _list[di].키값이 셋팅되도록 수정해야됨
							*/
							if(col.key == "fileYn") {
								if(_list[di].fileYn == "Y") {
									SS.push("<i class='" + col.colIcon + "'></i>");
								} else {
									SS.push("<i class=''></i>");
								}
							} else {
...
//                            SS.push('<i class="far fa-image fa-2x"></i>');
                            SS.push("</div>");
                            SS.push("</span>");
	                        SS.push('</td>');
                    	}
	                        ...
	                        SS.push('<a style="width:15%; font-size:15px"><i style="height:29px;" class="far fa-calendar-alt fa-w-14" data-calendar-event="true"></i></a>');
	                        SS.push('</td>');
                    	}
                    	else {
	                        SS.push(function (_cellHeight) {
            ...
            if (tblRowMaps.length > 1) {
                ...
                var _loop = function _loop(_ri, _rl) {
                    ...
                    var _loop2 = function _loop2(_ci2, _cl2) {
                        ...
                        if (!(_colGroup[_ci2].editor && _colGroup[_ci2].editor.type !== "checkbox") && function () {
        ...
        if (cfg.asidePanelWidth > 0) {
            ...
            if (cfg.footSum) {
                ...
                repaintSum.call(this, "bottom-aside-body", this.asideColGroup, asideBodyRowData, null, GRID.proxyData.getData.call(this));
            }
        }
        ...
        if (this.xvar.frozenColumnIndex > 0) {
            ...
            if (cfg.footSum && this.needToPaintSum) {
                // 바닥 요약
                repaintSum.call(this, "bottom-left-body", this.leftHeaderColGroup, leftFootSumData, GRID.proxyData.getData.call(this));
            }
        }
        ...
        // 바닥 요약
        if (cfg.footSum ) {
//        if (cfg.footSum && this.needToPaintSum) {		//2020.06.18 박광섭 footSum 적용을 위해 needToPaintSum 조건 없앰
            repaintSum.call(this, "bottom-body-scroll", headerColGroup, footSumData, GRID.proxyData.getData.call(this), scrollConfig);
        }
        // right
        if (cfg.rightSum) {}
        // todo : right 표현 정리
        ...
        /// mergeCells
        if (cfg.body.mergeCells && GRID.proxyData.size.call(this)) {	//this.list.length) {
            // left
            if (this.xvar.frozenColumnIndex > 0) {
                if (this.xvar.frozenRowIndex > 0) {
                    // 상단 행고정
    ...
    var scrollTo = function scrollTo(css, opts) {
        ...
        //2020.06.18 그리드 화면 깨지는 현상 때문에 일단 막아봄
//        if (this.isInlineEditing) {
...
//        }
    ...
    var moveFocus = function moveFocus(_position, _key) {
        var focus = {
            "UD": function UD(_dy) {
                var moveResult = true,
                ...
                var oldFocusedColumn = $.map(this.focusedColumn, function (a) {
                    return a
                });
                oldFocusedColumn = oldFocusedColumn.length > 0 ? oldFocusedColumn[0] : {
                        dindex: -1,
                ...
                if (this.canRowChange && oldFocusedColumn.dindex != focusedColumn.dindex) {
                    if (!this.canRowChange.call(this, {
                            self: this,
                            list: GRID.proxyData.getData.call(this),
                            dindex: focusedColumn.dindex,
                            item: GRID.proxyData.get.call(this, _dindex)
                        }))
                        return;
                }

                if (this.canCellChange &&
                    (oldFocusedColumn.dindex != focusedColumn.dindex || oldFocusedColumn.rowIndex != focusedColumn.rowIndex || oldFocusedColumn.colIndex != focusedColumn.colIndex)) {

                    if (!this.canCellChange.call(this, {
                            self: this,
                            list: GRID.proxyData.getData.call(this),
                            dindex: focusedColumn.dindex,
                            rowindex: focusedColumn.rowIndex,
                            colIndex: focusedColumn.colIndex,
                            key: (cols.filter(function (col) {
                                if (col.key && col.rowIndex == focusedColumn.rowIndex && col.colIndex == focusedColumn.colIndex) return true;
                            })[0] || [{key: undefined}][0]).key,
                            oldDindex: oldFocusedColumn.dindex,
                            oldRowindex: oldFocusedColumn.rowIndex,
                            oldColIndex: oldFocusedColumn.colIndex,
                ...
                if (_dy > 0) {
                    if (focusedColumn.rowIndex + (originalColumn.rowspan - 1) + _dy > this.bodyRowTable.rows.length - 1) {
                        ...
                        if (focusedColumn.dindex > GRID.proxyData.size.call(this) - 1) { 	//this.list.length - 1) {
                            focusedColumn.dindex = GRID.proxyData.size.call(this) - 1;	//this.list.length - 1;
                            moveResult = false;
                        }
                    } else {
                ...
                GRID.proxyData.setPosition.call(this, focusedColumn.dindex);

                if (this.onRowChanged && oldFocusedColumn.dindex != focusedColumn.dindex) {
                    this.onRowChanged.call(this, {
                        self: this,
                        list: GRID.proxyData.getData.call(this),
                        dindex: focusedColumn.dindex,
                        item: GRID.proxyData.get.call(this, focusedColumn.dindex)
                    });
                }
            ...
            "INDEX": function INDEX(_dindex, _key) {
                var moveResult = true,
                    focusedColumn = void 0,
                    originalColumn = void 0,
                    while_i = void 0;
                ...
                var colIndex = _key ? cols.filter(function (a) {
                        if (a.key == _key) return true;
                    })[0].colIndex : -1;
                var rowIndex = _key ? cols.filter(function (a) {
                        if (a.key == _key) return true;
                    })[0].rowIndex : -1;
                ...
                if (_dindex == "end") {
                    _dindex = GRID.proxyData.size.call(this) - 1;	//this.list.length - 1;
                }

                focusedColumn.dindex = _dindex;
                focusedColumn.rowIndex = rowIndex > -1 ? rowIndex : 0;
                focusedColumn.colIndex = colIndex > -1 ? colIndex : focusedColumn.colIndex;
        ...
        var processor = {
            ...
            "position": function position(_position, _key) {
                return focus["INDEX"].call(this, _position, _key);
            }
        };
        ...
        if (_position in processor) {
            return processor[_position].call(this);
        	 ...
        	 return processor["position"].call(this, _position, _key);
        }
    };
    ...
    var inlineEdit = {
        active: function active(_focusedColumn, _e, _initValue) {
            ...
            for (var key in _focusedColumn) {
             ...
             // editor disabled 체크
                if (U.isFunction(editor.disabled)) {
                	if(this.data._rows[dindex]._rowStatus =="NORMAL" || this.data._rows[dindex]._rowStatus =="UPDATE" || this.data._rows[dindex]._rowStatus =="DELETE" ) {		//입력모두이거나
	                    if (editor.disabled.call({
	                            list: GRID.proxyData.getData.call(this),	//this.list,
	                            dindex: dindex,
	                            item: GRID.proxyData.get.call(this, dindex),	//this.list[dindex],
	                            key: col.key,
	                            value: _initValue
	                        })) {
	                        return this;
                ...
                if (this.onBeforeEdit) {
                    if (!this.onBeforeEdit.call(this, {
                            self: this,
                            list: GRID.proxyData.getData.call(this),
                            dindex: dindex,
                            rowindex: rowIndex,
                            colIndex: colIndex,
                            item: GRID.proxyData.get.call(this, dindex),
                            key: col.key,
                            value: _initValue
                        }))
                        return;
                ...
                if (GRID.proxyData.isGrouping.call(this, dindex)) {	//this.list[dindex].__isGrouping) {
                    return false;
                }
            ...
            if (this.isInlineEditing) {
                ...
                /* 2020.06.12 by 박광섭 그리드 컬럼이 화면을 넘었을시 화면내에 마지막 컬럼 클릭시 화면 깨지는 현상에 의해 수정  Start */
//                var focusedColumn = jQuery.extend({}, this.focusedColumn[key], true);
//
//                var nPanelInfo = GRID.util.findPanelByColumnIndex.call(this, focusedColumn.dindex, focusedColumn.colIndex);
//
//                focusedColumn.panelName = nPanelInfo.panelName;
//                var containerPanelName = nPanelInfo.containerPanelName;
//                var isScrollPanel = nPanelInfo.isScrollPanel;
//
//                this.focusedColumn[focusedColumn.dindex + "_" + focusedColumn.colIndex + "_" + focusedColumn.rowIndex] = focusedColumn;
//
//                var $column = this.$.panel[focusedColumn.panelName].find('[data-ax5grid-tr-data-index="' + focusedColumn.dindex + '"]').find('[data-ax5grid-column-rowindex="' + focusedColumn.rowIndex + '"][data-ax5grid-column-colindex="' + focusedColumn.colIndex + '"]').attr('data-ax5grid-column-focused', "true");
...
//                    GRID.proxyData.setPosition.call(this, focusedColumn.dindex);
//                }
                /* 2020.06.12 by 박광섭 그리드 컬럼이 화면을 넘었을시 화면내에 마지막 컬럼 클릭시 화면 깨지는 현상에 의해 수정  End */
        ...
        deActive: function deActive(_msg, _key, _value) {
            ...
            var panelName = this.inlineEditing[_key].panelName,
                ...
                editorValue = function (inlineEditing) {
            		var $inlineEditor = inlineEditing.$inlineEditor;
            		var editor = $inlineEditor.instance;

            		if(editor && editor.getValue){
                        return editor.getValue($inlineEditor.get(0));
            ...
            var action = {
                ...
                "RETURN": function RETURN(_dindex,  _column, _newValue) {
                    if (GRID.data.setValue.call(this, _dindex,  _column.key, _newValue)) {
                        action["__clear"].call(this);
                        GRID.body.repaintCell.call(this, panelName, _dindex,  rowIndex, colIndex, _newValue);
                    } else {
                        action["__clear"].call(this);
                    }
                },
                ...
                "RETURN": function RETURN() {
                    if (this.isInlineEditing) {
                        ...
                        for (var k in this.focusedColumn) {
                            ...
                            if (column) {
                            	if (!GRID.proxyData.isGrouping.call(this, _dindex3)) {	// this.list[_dindex3].__isGrouping) {
...
//            GRID.header.repaint.call(this, true);
            ...
            for (di = 0, dl = _list.length; di < dl; di++) {
                ...
                for (tri = 0, trl = rowTable.rows.length; tri < trl; tri++) {
                    ...
                    for (ci = 0, cl = rowTable.rows[tri].cols.length; ci < cl; ci++) {
                        ...
                        //정규식을 이용한 이미지 제거 로직 추가 by 박광섭
                        for (i = 0, ii = SS.length; i < ii; i++) {
                        	SS[i] = String(SS[i]).replace(/<img[^>]*src=[\"']?([^>\"']+)[\"']?[^>]*>/, "");
                        }
                    }
                    SS.push('\n</tr>');
                }
    ...
    var toggleCollapse = function toggleCollapse(_dindex,  _collapse) {
        if (GRID.data.toggleCollapse.call(this, _dindex,  _collapse)) {
            this.proxyList = GRID.data.getProxyList.call(this, GRID.proxyData.getData.call(this));
            this.align();
        }
    };
    ...
    var click = function click(_dindex) {
        var that = {
            ...
            page: this.page,
            list: GRID.proxyData.getData.call(this),
            item: GRID.proxyData.getData.call(this, _dindex),
            dindex: _dindex
        };
...
(function () {
    ...
    var sum = function sum() {
        var value = 0,
        	i = this.list.length ;
//            i = GRID.proxyData.size.call(this).length;
        while (i--) {
...
(function () {
    ...
    var clearGroupingData = function clearGroupingData(_list) {
        var i = 0,
            ...
            returnList = [];
        for (; i < l; i++) {
            if (_list[i] && !GRID.proxyData.isGrouping.call(this, di)) {		//_list[i]["__isGrouping"]) {
                if (GRID.proxyData.isSelected.call(this, i)) {	//_list[i][this.config.columnKeys.selected]) {
    ...
    var initData = function initData(_list) {
        ...
        if (this.config.body.grouping) {
            GRID.proxyData.createGroupingData.call(this, this.bodyGrouping.by, this.selectedDataIndexs);
        ...
        for (; i < li; i++) {
            ...
            if (_list[i] && _list[i][keys.parentKey] !== "top" && typeof _list[i][keys.parentHash] === "undefined") {
                ...
                if (_parent = _list[listIndexMap[_list[i][keys.parentKey]]]) {
                    ...
                    // 트리 level _level 부터 펼치게 함
                    if (_list[i][keys.depth] == 1 ) {
                    	_list[i][keys.collapse] = true ;
                    }
    ...
    var set = function set(data) {
        ...
        if (U.isArray(data) || data instanceof DataSet) {
            this.page = null;
//            data.list = initData.call(this, GRID.proxyData.getData.call(this));
            GRID.proxyData.setData.call(this, data);
            if (!this.config.remoteSort && Object.keys(this.sortInfo).length)
                sort.call(this, this.sortInfo, GRID.proxyData.getData.call(this));
            list = initData.call(this, GRID.proxyData.getData.call(this));
            //list = initData.call(this, !this.config.remoteSort && Object.keys(this.sortInfo).length ? sort.call(this, this.sortInfo, data) : data);
        ...
        if (this.config.tree.use && GRID.proxyData.size.call(this) !=0 ) {
            this.list = arrangeData4tree.call(this, GRID.proxyData.getData.call(this));
            this.proxyList = getProxyList.call(this, sort.call(this, this.sortInfo, GRID.proxyData.getData.call(this)));
        } else {
            this.proxyList = null;
        ...
        this.xvar.frozenRowIndex = this.config.frozenRowIndex > GRID.proxyData.size.call(this) ? GRID.proxyData.size.call(this) : this.config.frozenRowIndex;
    ...
    var getList = function getList(_type) {
        var returnList = [];
        var i = 0,
            l = GRID.proxyData.size.call(this);	//this.list.length;
        switch (_type) {
            case "modified":
                for (; i < l; i++) {
                    //if (this.list[i] && !this.list[i]["__isGrouping"] && this.list[i][this.config.columnKeys.modified]) {
                    if (GRID.proxyData.get.call(this, i) && !GRID.proxyData.isGrouping.call(this, i) && GRID.proxyData.isModified.call(this, i)) {
                        returnList.push(jQuery.extend({}, GRID.proxyData.get.call(this, i)));
                    }
                }
                break;
            case "selected":
                for (; i < l; i++) {
                    if (GRID.proxyData.get.call(this, i) && !GRID.proxyData.isGrouping.call(this, i) && GRID.proxyData.isSelected.call(this, i)) {
                        returnList.push(jQuery.extend({}, GRID.proxyData.get.call(this, i)));	//this.list[i]));
                    }
                }
                break;
            case "deleted":
            ...
            default:
                GRID.proxyData.clearGroupingData.call(this);
                returnList = GRID.proxyData.getData.call(this);	//GRID.data.clearGroupingData.call(this, this.list);
        }
        return returnList;
    };
    ...
    var add = function add(_row, _dindex, _options) {
        ...
        if (this.config.body.grouping) {
            GRID.proxyData.sort.call(this, this.sortInfo);
            list = initData.call(this, GRID.proxyData.getData.call(this));	//sort.call(this, this.sortInfo, list));
     ...
     * ax5grid.data.remove
     */
    var remove = function remove(_dindex, _options) {
        //var list = this.config.body.grouping ? clearGroupingData.call(this, this.list) : this.list;
        var list;
        if (this.config.body.grouping)
            GRID.proxyData.clearGroupingData.call(this);
    ...
    var deleteRow = function deleteRow(_dindex) {
        ...
        if (this.config.tree.use) {
	        ...
	        if (this.config.body.grouping) {
            	...
            	list = initData.call(this, GRID.proxyData.getData.call(this));	//list);
        	}
        }
    ...
    var update = function update(_row, _dindex) {
        ...
        if (this.config.body.grouping) {
            GRID.proxyData.clearGroupingData.call(this);
            this.list = initData.call(this, GRID.proxyData.getData.call(this)); //clearGroupingData.call(this, this.list));
        }
    };
    var updateChild = function updateChild(_dindex, _updateData, _options) {
        var keys = this.config.tree.columnKeys,
            selfHash = void 0,
            originIndex = void 0,
            thisList = GRID.proxyData.getData.call(this);

        if (typeof _dindex === "undefined") return false;
        originIndex = this.proxyList[_dindex].__origin_index__;

        if (thisList[originIndex][keys.children]) {
            this.proxyList = []; // 리셋 프록시

            if (_options && _options.filter) {
                if (_options.filter.call({ item: thisList[originIndex], dindex: originIndex }, thisList[originIndex])) {
                    for (var _k in _updateData) {
                        thisList[originIndex][_k] = _updateData[_k];
                    }
                }
            } else {
                for (var _k2 in _updateData) {
                    thisList[originIndex][_k2] = _updateData[_k2];
                }
            }

            selfHash = thisList[originIndex][keys.selfHash];

            var i = 0,
                l = thisList.length;
            for (; i < l; i++) {
                if (thisList[i]) {
                    if (thisList[i][keys.parentHash].substr(0, selfHash.length) === selfHash) {

                        if (_options && _options.filter) {
                            if (_options.filter.call({ item: thisList[i], dindex: i }, thisList[i])) {
                                for (var _k3 in _updateData) {
                                    thisList[i][_k3] = _updateData[_k3];
                                }
                            }
                        } else {
                            for (var _k4 in _updateData) {
                                thisList[i][_k4] = _updateData[_k4];
                            }
                        }
                    }

                    if (!thisList[i][keys.hidden]) {
                        this.proxyList.push(thisList[i]);
                    }
                }
            }
    ...
    var setValue = function setValue(_dindex, _key, _value) {
        ...
        this.needToPaintSum = true;
        var thisList = GRID.proxyData.getData.call(this) ;
        ...
        if (this.canDataChange) {
            if (!this.canDataChange.call(this, {
                    ...
                    list: GRID.proxyData.getData.call(this), //this.list,
                    dindex: _dindex,
                    item: GRID.proxyData.get.call(this, _dindex), // this.list[_dindex],
                    key: _key,
                    value: _value,
                ...
                /*var repaintCell = function repaintCell(_panelName, _rows, __dindex, __key, __value) {
                 ...
                 repaintCell.call(this, "left-body", this.leftBodyRowData.rows, _dindex, _key, originalValue);
                 repaintCell.call(this, "body", this.bodyRowData.rows, _dindex, _key, originalValue);*/
                return false;
            }
        }
        ...
        if (originalValue !== _value) {
            if (/[\.\[\]]/.test(_key)) {
                try {
                    GRID.proxyData.setModified.call(this, _dindex, true);	//this.list[_dindex][this.config.columnKeys.modified] = true;
                    Function("val", "this" + GRID.util.getRealPathForDataItem(_key) + " = val;").call(thisList[_dindex], _value);
                } catch (e) {
                }
            } else {
                GRID.proxyData.setModified.call(this, _dindex, true);	//this.list[_dindex][this.config.columnKeys.modified] = true;
                GRID.proxyData.set.call(this, _dindex, _key, _value);	//this.list[_dindex][_key] = _value;
            }

            if (this.onDataChanged) {
                this.onDataChanged.call(this, {
                    self: this,
                    type: "VALUE",
                    list: GRID.proxyData.getData.call(this), //this.list,
                    dindex: _dindex,
    ...
    var getValue = function getValue(_dindex, _key, _value) {
        ...
        if (/[\.\[\]]/.test(_key)) {
            ...
            _value = GRID.proxyData.get.call(this, _dindex, _key); //this.list[_dindex][_key];
        }
        return _value;
    };
    ...
    var select = function select(_dindex, _selected, _options) {
        ...
        if (GRID.proxyData.isGrouping.call(this, _dindex)) return false;	//this.list[_dindex].__isGrouping) return false;
        if (GRID.proxyData.isDisableSelection.call(this, _dindex)) return false;	//this.list[_dindex][cfg.columnKeys.disableSelection]) return false;

        _selected = typeof _selected === "undefined" ? !GRID.proxyData.isSelected.call(this, _dindex) : _selected;
        ...
        if (this.canDataChange) {
            if (!this.canDataChange.call(this, {
                    ...
                    item: GRID.proxyData.get.call(this, _dindex), // this.list[_dindex],
                    value: _selected,
                    originalValue: !_selected
                }))
                return;
        }

        GRID.proxyData.setSelected.call(this, _dindex, _selected);
        if (_selected) {
        ...
        if (this.onDataChanged && _options && _options.internalCall) {
            this.onDataChanged.call(this, {
                ...
                dindex: _dindex,
                item: GRID.proxyData.get.call(this, _dindex),	//this.list[_dindex],
                value: GRID.proxyData.isSelected.call(this, _dindex)	//this.list[_dindex][cfg.columnKeys.selected]
            });
        }

        return GRID.proxyData.isSelected.call(this, _dindex); //this.list[_dindex][cfg.columnKeys.selected];
    };

    var selectAll = function selectAll(_selected, _options) {
        var cfg = this.config,
            dindex = GRID.proxyData.size.call(this);	//this.list.length;
        var thisList = GRID.proxyData.getData.call(this) ;

        if (typeof _selected === "undefined") {
            while (dindex--) {
                if (GRID.proxyData.isGrouping.call(this, dindex)) continue;	//this.list[dindex].__isGrouping) continue;
                if (_options && _options.filter) {
                    if (_options.filter.call(thisList[dindex]) !== true) {
                        continue;
                    }
                }
                if (GRID.proxyData.isDisableSelection.call(this, dindex)) continue;	//this.list[dindex][cfg.columnKeys.disableSelection]) continue;

                //if (this.list[dindex][cfg.columnKeys.selected] = !this.list[dindex][cfg.columnKeys.selected]) {
                GRID.proxyData.setSelected.call(this, dindex, !GRID.proxyData.isSelected.call(this, dindex));
                if (GRID.proxyData.isSelected.call(this, dindex)) {
            ...
            while (dindex--) {
                ...
                GRID.proxyData.setSelected.call(this, dindex, _selected)
                if (GRID.proxyData.isSelected.call(this, dindex)) {
                    this.selectedDataIndexs.push(dindex);
                }
            }
    ...
    var sort = function sort(_sortInfo, _list) {
        var self = this,
            list = _list || GRID.proxyData.getData.call(this),//this.list,
            sortInfoArray = [];
    ...
    var append = function append(_list, _callback) {
        ...
        if (this.config.tree.use) {
            var list = thisList.concat([].concat(_list));

            this.list = arrangeData4tree.call(this, list);
            this.proxyList = getProxyList.call(this, sort.call(this, this.sortInfo, thisList));
            list = null;
        } else {
            this.list = thisList.concat([].concat(_list));
        }
    ...
    var appendIdle = function appendIdle() {
        ...
        if (this.config.body.grouping) {
            GRID.proxyData.sort.call(this, this.sortInfo);
            initData.call(this, GRID.proxyData.getData.call(this));	//sort.call(this, this.sortInfo, this.list));
        } else {
            initData.call(this, GRID.proxyData.getData.call(this));
        }
    ...
    var toggleCollapse = function toggleCollapse(_dindex, _collapse) {
        ...
        if (thisList[originIndex][keys.children]) {
            ...
            if (typeof _collapse == "undefined") {
                _collapse = !(thisList[originIndex][keys.collapse] || false);
            }

            thisList[originIndex][keys.collapse] = _collapse;
            selfHash = thisList[originIndex][keys.selfHash];
            ...
            while (i--) {
                if (thisList[i]) {
                    ...
                    if (thisList[i][keys.parentHash].substr(0, selfHash.length) === selfHash) {
                        thisList[i][keys.hidden] = _collapse;
                    }
    ...
    var init = function init() {
        ...
        this.$["container"]["header"].on("click", '[data-ax5grid-column-attr]', function (e) {
            ...
            if (key === "__checkbox_header__" && self.config.header.selector) {
                ...
                self.selectAll({selected: selected}, $(this));

                selected = null;
            } else if (key === "__index_header__" && self.config.header.selector) {
            	gf_DataSetFilter(self) ;
            ...
            GRID.body.blur.call(self);
            $(".ax5-ui-dialog").draggable();
            key = null;
            colIndex = null;
            col = null;
        });

        this.$["container"]["header"].on("click", '[data-ax5grid-column-filter]', function (e) {
        	alert('!');
//            var key = this.getAttribute("data-ax5grid-column-filter"),
//            	label = this.getAttribute("data-ax5grid-column-filter-label"),
//            	value = this.getAttribute("data-ax5grid-column-filter-value"),
//            	returnValue
//            var setThis = this ;
//
...
//
//            promptDialog.prompt({
//                input: {filter: {label: label, type: "text", value: returnValue}}
//            }, function () {
//            	if(this.key == "ok"){
////            		self.cf_filter() ;
////            		returnValue = this.filter ;
//                    returnValue = this.filter ;
//                    setThis.setAttribute("data-ax5grid-column-filter-value", returnValue) ;
//                    returnValue = returnValue  ;
//            	} else {
//            		returnValue = value ;
//            	}
...
//                        }
                        ...
                        if (_col.headerStyleClass) {
                            if (U.isFunction(_col.headerStyleClass)) {
                                tdCSS_class += _col.headerStyleClass.call(this, {
                                        column: _col,
                                        key: _col.key
                                    }) + " ";
                            } else {
...
//그리드 Header에 이미지 표시함
//                      if (col.enableFilter) {
//                    	  _SS += '<span data-ax5grid-column-filter="' + col.key + '" data-ax5grid-column-filter-label="' + col.label  + '" data-ax5grid-column-filter-value="111"/>';
//                      }
                        return _SS;
...
//                seq++;
            ...
            if (Number(seq) < Number(this.sortInfo[k].seq)) {		//Sort 기준값중 가장큰값을 가져온다
            	seq = this.sortInfo[k].seq ;
            }
            useYn = "Y" ;
        }
        ...
        for (var i = 0, l = this.colGroup.length; i < l; i++) {
            if (this.colGroup[i].key == _key) {
                if (sortOrder == "") {
                    if (typeof this.colGroup[i].sort === "undefined" ||this.colGroup[i].sort === "" ) {
                        sortOrder = "desc";
                        if (this.colGroup[i].sortSeq !="") {
                        	sortSeq =  this.colGroup[i].sortSeq ;
                        } else {
                        	if(useYn == "N") {
                        		sortSeq = "0" ;
                        	} else {
                        		sortSeq =  String(Number(seq) + 1) ;
                        	}
                        }
                        ...
                        for (var j = 0, l = this.colGroup.length; j < l; j++) {
                        	if (this.colGroup[j].sortSeq != "") {
                        		if(Number(sortSeq) < Number(this.colGroup[j].sortSeq)) {
                        			this.colGroup[j].sortSeq = String(Number(this.colGroup[j].sortSeq) - 1) ;
                        		}
                        	}
                        }
                        sortSeq = "" ;
                ...
                this.colGroup[i].sortSeq = sortSeq;
            } else if (!this.config.multiSort) {
                this.colGroup[i].sort = undefined;
            }
        }
        for (var k = 0, l = this.colGroup.length; k < l; k++) {
	        if (typeof this.colGroup[k].sort !== "undefined") {
	            if (!sortInfo[this.colGroup[k].key]) {
	                sortInfo[this.colGroup[k].key] = {
	                    seq: Number(this.colGroup[k].sortSeq),
	                    orderBy: this.colGroup[k].sort,
	                    formatter: this.colGroup[k].formatter
	                };
	            }
	        }
        }
...
(function () {
    ...
    var edit_date = {
        ...
        editMode: "popup",
        getHtml: function getHtml(_root, _columnKey, _editor, _value) {
            return '<input type="text" numberOnly data-ax5grid-editor="calendar" value="' + _value + '" >';
        },
        init: function init(_root, _columnKey, _editor, _$parent, _value) {
            var $el;
            _$parent.append($el = jQuery(this.getHtml(_root, _columnKey, _editor, _value)));
...
(function () {
        ...
        "click": function click(track, bar, type, e) {
            ...
            var self = this,
                ...
                "vertical": function vertical(e) {
                    ...
                    var mouseClick = mouseObj.clientY - trackOffset.top;
                    var newTop ;
                    if((mouseClick) > barBox.barPosition.top) {
                    	newTop = barBox.barPosition.top + barBox.height ;
                    } else {
                    	newTop = barBox.barPosition.top - barBox.height ;
                    }
                    if (newTop < 0) {
                ...
                "verticalUp": function vertical(e) {
                    var mouseObj = GRID.util.getMousePosition(e);
                    // track을 벗어 나지 안도록 범위 체크
                    var mouseClick = mouseObj.clientY - trackOffset.top;
                    var newTop ;
                ...
                "verticalDown": function vertical(e) {
                    var mouseObj = GRID.util.getMousePosition(e);
                    // track을 벗어 나지 안도록 범위 체크
                    var mouseClick = mouseObj.clientY - trackOffset.top;
                    var newTop ;
                    if((mouseClick) > barBox.barPosition.top) {
                    	newTop = barBox.barPosition.top + barBox.height ;
                    	newTop = barBox.barPosition.top - 29 ;
                    }
                    if (newTop < 0) {
                        newTop = 0;
                    } else if (newTop + barBox.height > trackBox.height) {
    ...
    var init = function init() {
        ...
        this.$["scroller"]["vertical-arrowDown"].on(GRID.util.ENM["mousedown"], function (e) {
            this.xvar.mousePosition = GRID.util.getMousePosition(e);
            scrollBarMover.on.call(this, this.$["scroller"]["vertical"], this.$["scroller"]["vertical-arrowDown"], "verticalDown", e);
        }.bind(this)).on("dragstart", function (e) {
            U.stopEvent(e);
            return false;
        });

        this.$["scroller"]["vertical-arrowUp"].on(GRID.util.ENM["mousedown"], function (e) {
            this.xvar.mousePosition = GRID.util.getMousePosition(e);
            scrollBarMover.on.call(this, this.$["scroller"]["vertical"], this.$["scroller"]["vertical-arrowUp"], "verticalUp", e);
        }.bind(this)).on("dragstart", function (e) {
            U.stopEvent(e);
            return false;
        });
...
(function () {
    ...
    var setDefaultFormatter = function (field) {
        if (field.formatter)
            return;
        ...
        if (field.editor.type == "select" || field.editor.type == "date")
            field.formatter = field.editor.type;
    };
        ...
        var columns = _columns,
            ...
            for (; i < l; i++) {
                ...
                if (!field.hidden) {
                    ...
                    //editor에 대한 기본적인 포메터가 존재할 경우 강제로 삽입한다.
                    setDefaultFormatter(field);
        ...
        for (var r = 0, rl = _footSumColumns.length; r < rl; r++) {
            ...
            if (addC < this.colGroup.length) {
                for (var _c = addC; _c < this.colGroup.length; _c++) {
                    table.rows[r].cols.push({
                    	colIndex: this.colGroup[c].colIndex,
                        colspan: this.colGroup[c].colspan,
                        rowspan: 1,
                        key: this.colGroup[c].key,
                        label: "&nbsp;"
                    });
                }
            }
    ...
    var makeBodyGroupingTable = function makeBodyGroupingTable(_bodyGroupingColumns) {
        /* var table = {
         ...
         r = 0,
         addC = 0;
         var bodyTable = ax5.ui.grid.util.makeBodyRowTable.call(this, this.columns);
         var groupingTable = ax5.ui.grid.util.makeBodyRowTable.call(this, _bodyGroupingColumns);
        ...
        var columns = U.deepCopy(_bodyGroupingColumns);
        var table = {
            rows: []
        };
        var colIndex = 0;
            ...
            var selfMakeRow = function selfMakeRow(__columns) {
                ...
                for (; i < l; i++) {
                    ...
                    if (!field.hidden) {
                        ...
                        if ('key' in field || 'label' in field) {
                            field.colspan = 1;
                            field.rowspan = 1;
...
//ax5.ui.grid.proxyData
(function () {

  var GRID = ax5.ui.grid;
  var U = ax5.util;

  var BaseData = function (_data) {
      var data = _data;
      var deletedList = [];
      this.getData = function () {
          return data;
      };
      this.set = function (_row, _colId, _value) {
          data[_row][_colId] = _value;
      };
      this.setPosition = function (_row) {
      };
      this.get = function (_row, _colId) {
          if (!_colId)
              return data[_row];
          return data[_row][_colId];
      };
      this.getGroupingList = function (_row) {
          return data[_row]["__groupingList"];
      };
      this.getGroupingBy = function (_row) {
          return data[_row]["__groupingBy"];
      };
      this.remove = function (_row) {
          data = data.slice(0, _row).concat(data.slice(_row));
      };
      this.size = function () {
          return data.length;
      };
      ...
      this.sort = function (_sortInfo) {
          var list = data;
          var sortInfoArray = [];
          var that;
          var getKeyValue = function getKeyValue(_item, _key, formatter) {
              var _value = "";
              that = {
                  key: _key,
                  item: _item,
          ...
          list.sort(function (_a, _b) {
              for (i = 0; i < l; i++) {
                  _a_val = getKeyValue(_a, sortInfoArray[i].key, sortInfoArray[i].formatter);
                  _b_val = getKeyValue(_b, sortInfoArray[i].key, sortInfoArray[i].formatter);
      ...
      this.isGrouping = function (_row) {
          return data[_row].__isGrouping;
      };
      this.isModified = function (_row) {
          return data[_row].__modified__;
      };
      this.setModified = function (_row, _value) {
          data[_row].__modified__ = _value;
      };
      this.isDisableSelection = function (_row) {
          return data[_row].__disable_selection__;
      };
      this.isSelected = function (_row) {
          return data[_row].__selected__;
      };
      this.setSelected = function (_row, _value) {
          data[_row].__selected__ = _value;
      };
      this.createGroupingData = function (_groupingBy, selectedDataIndexs) {
          var i = 0,
              l = data.length,
              returnList = [],
              appendIndex = 0,
              dataRealRowCount = 0;
          var groupingKeys = U.map(_groupingBy, function () {
              return {
                  key: this,
                  compareString: "",
                  grouping: false,
          ...
          for (; i < l + 1; i++) {
              gi = 0;
              if (data[i] && data[i]["__deleted__"]) {	//this.config.columnKeys.deleted]) {
                  this.deletedList.push(data[i]);
              } else {
                  compareString = "";
                  appendRow = [];
                  for (; gi < gl; gi++) {
                      if (data[i]) {
                          compareString += "$|$" + data[i][groupingKeys[gi].key];
                      }
                      if (appendIndex > 0 && compareString != groupingKeys[gi].compareString) {
                          var appendRowItem = {keys: [], labels: [], list: groupingKeys[gi].list};
                          for (var ki = 0; ki < gi + 1; ki++) {
                              appendRowItem.keys.push(groupingKeys[ki].key);
                              appendRowItem.labels.push(data[i - 1][groupingKeys[ki].key]);
                          }
                          appendRow.push(appendRowItem);
                          groupingKeys[gi].list = [];
                      }
                      groupingKeys[gi].list.push(data[i]);
                      groupingKeys[gi].compareString = compareString;
                  }
                  ...
                  while (ari--) {
                      returnList.push({
                          ...
                          __groupingBy: {keys: appendRow[ari].keys, labels: appendRow[ari].labels}
                      });
                  }

                  if (data[i]) {
                      if (data[i]["__selected__"]) {
                          selectedDataIndexs.push(i);
                      }
                      dataRealRowCount = data[i]["__index"] = i;
      ...
      this.clearGroupingData = function () {
          var i = 0,
              l = data.length,
              returnList = [];
          for (; i < l; i++) {
              if (data[i] && !data[i]["__isGrouping"]) {
                  if (data[i]["__selected"]) {
                      this.selectedDataIndexs.push(i);
                  }
                  returnList.push(jQuery.extend({}, data[i]));
              }
          }
          data = returnList;
      };
  ...
  var getData = function () {
      if (this.data) {
          return this.data.getData ? this.data.getData() : this.data.getViewAll();
      }
      return [];
  };

  var get = function (_row, _colId) {
  	var row = _row;
  	if(_row == "START"){
  		row = this.data.size() > 0? 0: -1;
  	}else if(_row == "END"){
  		row = this.data.size() > 0? this.data.size()-1: -1;
  	}
      return row < 0 ? {}: this.data.get(row, _colId);
  };

  var getGroupingList = function (_row) {
      return this.data.getGroupingList(_row);
  };

  var getGroupingBy = function (_row) {
      return this.data.getGroupingBy(_row);
  };

  var set = function (_row, _colId, _value) {
      this.data.set(_row, _colId, _value, this);
  };

  var setPosition = function (_row) {
  	var row = _row;
  	if(_row == "START"){
  		row = this.data.size() > 0? 0: -1;
  	}else if(_row == "END"){
      ...
      this.data.setPosition(row, false, this);
  };

  var remove = function (_row) {
      this.data.remove(_row);
  };
  ...
  var sort = function (_sortInfo) {
      this.data.sort(_sortInfo, null, this);
  };

  var isGrouping = function (_row) {
      var _this = this;
      if (typeof(_row) != "undefined")
          return this.data.isGrouping ? this.data.isGrouping(_row) : false;

      return (_this.data.getData ? _this.data.getData() : _this.data.getViewAll()).map(function (obj, seq) {
              return _this.data.isGrouping(seq);
          }).indexOf(true) > -1
  };

  var isModified = function (_row) {
      return this.data.isModified ? this.data.isModified(_row) : true;
  };

  var setModified = function (_row, _value) {
      if (this.data.setModified)
          this.data.setModified(_row, _value);
  };

  var isDisableSelection = function (_row) {
      return this.data.isDisableSelection ? this.data.isDisableSelection(_row) : true;
  };

  var isSelected = function (_row) {
      return this.data.isSelected ? this.data.isSelected(_row) : false;
  };

  var setSelected = function (_row, _value) {
      if (this.data.setSelected)
          this.data.setSelected(_row, _value);
  };
  var createGroupingData = function (_groupingBy, selectedDataIndexs) {
      if (this.data.createGroupingData)
          this.data.createGroupingData(_groupingBy, selectedDataIndexs);
  }
  var clearGroupingData = function () {
      this.data.clearGroupingData();
  }
  ...
  GRID.proxyData = {
      ...
      getData: getData,
      get: get,
      getGroupingList: getGroupingList,
      getGroupingBy: getGroupingBy,
      set: set,
      ...
      isDisableSelection: isDisableSelection,
      isSelected: isSelected,
      setSelected: setSelected,
      createGroupingData: createGroupingData,
      clearGroupingData: clearGroupingData
  };
})();